use crate::utils::constants::Errors::AudioDeviceError;
// use cpal::{
//     self,
...
// pub fn setup_device() -> Result<(Device, SupportedStreamConfig), Box<dyn Error>> {
//     let host = cpal::default_host();
//     let device = match host.default_output_device() {
//         Some(device) => device,
//         None => return Err(Box::new(AudioDeviceError::AudioDeviceNotFound)),
//     };
